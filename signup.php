    ...
    <div class="grid">
      ...
      <form method="POST" class="form login">
        ...
        <div class="form__field">
          ...
          <input autocomplete="off" id="email" type="text" name="username" class="form__input" placeholder="Username" required>
        </div>
        ...
        <div class="form__field">
          <input type="submit" name="submit" style="background-color: #2585e6;"value="Sign up">
        </div>
